...
export default function ChatWidget() {
  ...
  async function callBot(newHistory) {
    ...
    try {
      ...
      const reply =
        data.reply || "I am currently undergoing upgrades for Next.js!";
            ...
            >
              {msg.type === "greeting" ?
                <>
                  ...
                  >
                    Hey there! I'm SNH's AI cart finder
                    <br />
                    <br />
                    I can help you find the perfect golf cart in about 60
                    seconds.
                    <br />
                    <br />
                    Want to start?
                ...
                {[0, 0.2, 0.4].map((delay, i) => (
                  <div
                    ...
                    style={{
                      ...
                      animation: "snhBounce 1.2s infinite",
        ...
        >
          <textarea
            ...
            style={{
              ...
              fontFamily: "inherit",
              scrollbarWidth: "thin",
              scrollbarColor: "rgba(200,168,75,0.4) transparent",
            }}
            onFocus={(e) =>
